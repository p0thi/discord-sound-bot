...
export default class ContextMenuCommandManager extends ACommandManager {
  private static _instance: ContextMenuCommandManager;
  ...
  static getInstance(bot: Client): ContextMenuCommandManager {
    if (!ContextMenuCommandManager._instance) {
      ContextMenuCommandManager._instance = new ContextMenuCommandManager(bot);
    }
    return ContextMenuCommandManager._instance;
  }
